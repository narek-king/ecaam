...
//pagination
	...
	$tableName='diaspora';		//your table name
	...
	*/
	...
	$targetpage = "diaspora.php"; 	//your file name  (the name of this file)
...
<div style='width:100%;padding:4px;'><h2><a href='more.php?id=$id&abc=diaspora'>$title</a></h2></div>
<div style='width:100%;padding:4px;'>$short</div>
</td>
</tr>
<tr>
<td  style='height:30px;padding:4px;'>
<a href='more.php?id=$id&abc=diaspora' class='more' style='color:white' >$more</a>
</td>
<td></td>
</tr>
</table>
