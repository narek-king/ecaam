...
?>
<div style="width:1000px; height:70px;margin:auto;text-align:center;margin-top:-30px; background:url(../img/bg2.png)"><h1>PRESS Page Content</h1></div>
<div <div align="center" style="width:950px; height:100%;margin:auto;background:url(../img/bg2.png);padding:25px;">
<table width="100%">
<?include ('sqlconfig.php');
	$query= mysql_query("SELECT * FROM presscontent");
while($res = mysql_fetch_array($query)){
    echo '
    <form method=post action="edit.php">
    <tr><td><a class="eca" href="http://eca.am/more.php?id='.$res['id'].'&abc=presscontent" target="_blank">'.$res['title_arm'].'</a><br /><br /><a href="update.php?this=presscontent&id='.$res['id'].'"><img style="width:21px;height:21px;" src="../images/news/img/edit.png" ></a>
    <input type="submit" value=" " name="delete" class="del" />
    <input type="hidden" name="id" value="'.$res['id'].'" />
    <input type="hidden" name="image" value="'.$res['image'].'" />
    <input type="hidden" value="presscontent" name="this" /><hr></td></tr>
...
<input type="hidden" value="presscontent" name="this" />
...
<tr><td><input type="hidden" value="presscontent" name="this" /><input type="submit" name="submit" value="save" /></td></tr>
</table>
</form>
</div>
