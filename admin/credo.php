...
include "menu.php";
?>
<div style="width:1000px; height:220px;margin:auto;text-align:center;margin-top:-30px; background:url(../img/bg2.png)"><h1>Credo Page Content</h1></div>
<div align="center" style="width:1000px; height:100%;margin:auto;background:url(../img/bg2.png)">
<?include ('sqlconfig.php');
	$query= mysql_query("SELECT * FROM worldcouncil WHERE id=1");
...
<form method="post" action="php/worldcoedit.php">
<b>Content Arm:</b><textarea name="contarm"><? echo $res['contentarm']; ?></textarea><br />
<b>Content Eng:</b><textarea name="conteng"><? echo $res['contenteng']; ?></textarea><br />
