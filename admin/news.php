...
?>
<div style="width:1000px; height:70px;margin:auto;text-align:center;margin-top:-30px; background:url(../img/bg2.png)"><h1>NEWS Page Content</h1></div>
...
while($res = mysql_fetch_array($query)){
    ...
    <tr><td><a class="eca" href="http://eca.am/more.php?id='.$res['id'].'&abc=newscontent" target="_blank">'.$res['title_arm'].'</a><br /><br /><a href="update.php?this=newscontent&id='.$res['id'].'"><img style="width:21px;height:21px;" src="../images/news/img/edit.png" ></a>
    <input type="submit" value=" " name="delete" class="del" />
    <input type="hidden" name="id" value="'.$res['id'].'" />
    <input type="hidden" name="image" value="'.$res['image'].'" />
    <input type="hidden" value="newscontent" name="this" /><hr></td></tr>
...
<input type="hidden" value="newscontent" name="this" />
...
<tr><td>Long text:</td><td><textarea class="content" name="contentarm" rows="25" cols="40"></textarea></td><td><textarea class="content" name="contenteng" rows="25" cols="40"></textarea></td></tr>
<tr><td><input type="hidden" value="newscontent" name="this" /><input type="submit" name="submit" value="save" /></td></tr>
</table>
</form>
</div>
