...
mysql_query("INSERT INTO `presscontent`(`image`,`title_arm`,`title_eng`,`short_text_arm`,`short_text_eng`,`content_arm`,`content_eng`) VALUES ('$image','$titlearm','$titleeng','$short_text_arm','$short_text_eng','$contentarm','$contenteng')");
...
$insert= mysql_query("DELETE FROM presscontent WHERE id='$id'");
printf("<script>document.location.href='../press.php'</script>");
	if (is_file($filelink)) {
