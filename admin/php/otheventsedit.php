...
mysql_query("INSERT INTO `otherevents`(`image`,`title_arm`,`title_eng`,`short_text_arm`,`short_text_eng`,`content_arm`,`content_eng`) VALUES ('$image','$titlearm','$titleeng','$short_text_arm','$short_text_eng','$contentarm','$contenteng')");
...
$insert= mysql_query("DELETE FROM otherevents WHERE id='$id'");
printf("<script>document.location.href='../otherevents.php'</script>");
	if (is_file($filelink)) {
