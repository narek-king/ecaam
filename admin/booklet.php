...
include "menu.php";
?>
<div style="width:1000px; height:220px;margin:auto;text-align:center;margin-top:-30px; background:url(../img/bg2.png)"><h1>Zhats... booklet Page Content</h1></div>
<div align="center" style="width:1000px; height:100%;margin:auto;background:url(../img/bg2.png)">
<?include ('sqlconfig.php');
	$query= mysql_query("SELECT * FROM booklet WHERE id=1");
...
<div align="center" style="width:1000px; height:100%;margin:auto;background:url(../img/bg2.png)">
<?
echo '<form method="post" action="php/bookletedit.php">
