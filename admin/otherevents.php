...
<table width="100%">
<?include ('sqlconfig.php');
	$query= mysql_query("SELECT * FROM otherevents");
while($res = mysql_fetch_array($query)){
    echo '
    <form method=post action="edit.php">
    <tr><td><a class="eca" href="http://webex.am/eca.am/more.php?id='.$res['id'].'&abc=otherevents" target="_blank">'.$res['title_arm'].'</a><br /><br /><a href="update.php?this=otherevents&id='.$res['id'].'"><img style="width:21px;height:21px;" src="../images/news/img/edit.png" ></a>
    <input type="submit" value=" " name="delete" class="del" />
    <input type="hidden" name="id" value="'.$res['id'].'" />
    <input type="hidden" name="image" value="'.$res['image'].'" />
    <input type="hidden" value="otherevents" name="this" /><hr></td></tr>
...
<input type="hidden" value="othereventst" name="this" />
...
<tr><td><input type="hidden" value="otherevents" name="this" /><input type="submit" name="submit" value="save" /></td></tr>
</table>
</form>
</div>
