...
?>
<div style="width:1000px; height:70px;margin:auto;text-align:center;margin-top:-30px; background:url(../img/bg2.png)"><h1>VIDEO Page Content</h1></div>
...
while($res = mysql_fetch_array($query)){
    ...
    <tr><td><a class="eca" href="http://webex.am/eca.am/more.php?id='.$res['id'].'&abc=video" target="_blank">'.$res['title_arm'].'</a><br /><br /><a href="update.php?this=video&id='.$res['id'].'"><img style="width:21px;height:21px;" src="../images/news/img/edit.png" ></a>
    <input type="submit" value=" " name="delete" class="del" />
    <input type="hidden" name="id" value="'.$res['id'].'" />
    <input type="hidden" name="image" value="'.$res['link'].'" />
    <input type="hidden" value="video" name="this" /><hr></td></tr>
    </form>
    ';
...
<input type="hidden" value="churches" name="this" />
...
<table>
<tr><td></td><td>Example: http://www.youtube.com/watch?v=<font color="red">AqyGUltWd0U</font></td><td><input type="text" name="video"></td></tr>
...
<tr><td><input type="hidden" value="video" name="this" /><input type="submit" name="submit" value="save" /></td></tr>
</table>
</form>
</div>
