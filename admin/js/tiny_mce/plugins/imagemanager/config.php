<?php
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,pdf,docx,xls";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,doc,pdf,docx,xls";
