...
include "menu.php";
?>
<div style="width:1000px; height:220px;margin:auto;text-align:center;margin-top:-30px; background:url(../img/bg2.png)"><h1>ECA structure Page Content</h1></div>
<div align="center" style="width:1000px; height:100%;margin:auto;background:url(../img/bg2.png)">
<?include ('sqlconfig.php');
	$query= mysql_query("SELECT * FROM ecastructure");
while($res = mysql_fetch_array($query)){
echo "<hr><b>Content Arm</b><br><hr>".$res['contentarm']."<br><hr><b>Content Eng</b><br><hr>".$res['contenteng'];
echo '<form method="POST" action="php/structedit.php">
...
<div align="center" style="width:1000px; height:100%;margin:auto;background:url(../img/bg2.png)">
<form method="post" action="php/structedit.php">
<b>Content Arm:</b><textarea name="contarm"></textarea><br><b>Content Eng:</b><textarea name="conteng"></textarea><br><input type="submit" name="submit" value="save" />
</form>
</div>
