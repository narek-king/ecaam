...
$tinybrowser['path']['image'] = '/eca.am/admin/images/uploads/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/eca.am/admin/images/uploads/'; // Media files location
$tinybrowser['path']['file']  = '/eca.am/admin/images/uploads/'; // Other files location
