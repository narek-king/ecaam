...
include "menu.php";
?>
<div style="width:1000px; height:70px;margin:auto;text-align:center;margin-top:-30px; background:url(../img/bg2.png)"><h1>ANNOUNCEMENTS Page Content</h1></div>
<div <div align="center" style="width:950px; height:100%;margin:auto;background:url(../img/bg2.png);padding:25px;">
<table width="100%">
<?include ('sqlconfig.php');
	$query= mysql_query("SELECT * FROM religioussites");
while($res = mysql_fetch_array($query)){
    echo '
    <form method=post action="edit.php">
    <tr><td><a class="eca" href="http://webex.am/eca.am/more.php?id='.$res['id'].'&abc=religioussites" target="_blank">'.$res['title_arm'].'</a><br /><br /><a href="update.php?this=religioussites&id='.$res['id'].'"><img style="width:21px;height:21px;" src="../images/news/img/edit.png" ></a>
    <input type="submit" value=" " name="delete" class="del" />
    <input type="hidden" name="id" value="'.$res['id'].'" />
    <input type="hidden" name="image" value="'.$res['image'].'" />
    <input type="hidden" value="religioussites" name="this" /><hr></td></tr>
...
<input type="hidden" value="religioussites" name="this" />
...
<form method="post" action="php/religiousedit.php" enctype="multipart/form-data">
<table>
<tr><td></td><td><input type="file" name="img"></td><td></td></tr>
<tr><td></td><td>content Arm</td><td>Content Eng</td></tr>
<tr><td>Title:</td><td><textarea name="title1" cols="44"></textarea></td><td><textarea name="title2" cols="44"></textarea></td></tr>
<tr><td>Short text:</td><td><textarea name="short_text1" cols="44"></textarea></td><td><textarea name="short_text2" cols="44"></textarea></td></tr>
