...
include ('datebase/sqlconfig.php');
	...
	$tableName='video';		//your table name
...
<tr>
<td style='width:220px;height:190px;padding:2px;'>";
echo'<object width="220" height="190">
		<param name="movie" value="http://www.youtube.com/v/'.$video.'?hl=ru_RU&amp;version=3"></param>
		<param name="allowFullScreen" value="true"></param>
		<param name="allowscriptaccess" value="always"></param>
		<param name="wmode" value="opaque"/>
		<embed wmode="opaque" src="http://www.youtube.com/v/'.$video.'?hl=ru_RU&amp;version=3" type="application/x-shockwave-flash" width="220" height="190" allowscriptaccess="always" allowfullscreen="true"></embed>
		</object>';


echo "</td>
<td style='width:600px;height:130px;padding:4px;'>
<div style='width:100%;padding:4px;'><h2><a href='more_video.php?id=$id'>$title</a></h2></div>
<div style='width:100%;padding:4px;'>$short</div>
</td>
</tr>
<tr>
<td  style='height:30px;padding:4px;'>
<a href='more_video.php?id=$id' class='more' style='color:white'>".$more."</a>
</td>
<td></td>
</tr>
</table>
