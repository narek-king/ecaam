...
//pagination
	...
	$tableName='articles';		//your table name
	...
	*/
	...
	$targetpage = "articles.php"; 	//your file name  (the name of this file)
...
<div style='width:100%;padding:4px;'><h2><a href='more.php?id=$id&abc=articles'>$title</a></h2></div>
<div style='width:100%;padding:4px;'>$short</div>
</td>
</tr>
<tr>
<td  style='height:30px;padding:4px;'>
<a href='more.php?id=$id&abc=articles' class='more' style='color:white' >$more</a>
</td>
<td></td>
</tr>
</table>
