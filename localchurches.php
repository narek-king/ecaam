...
//pagination
	...
	$tableName='churches';		//your table name
	...
	*/
	...
	$targetpage = "localchurches.php"; 	//your file name  (the name of this file)
...
$title=$row['title_arm'];
$short=$row['short_text_arm'];
$id=$row['id'];
echo "
<table width='100%' border='0'>
<tr>
<td style='width:130px;height:130px;padding:4px;'><img width='100%' height='100%' src='$image' /></td>
<td style='width:600px;height:130px;padding:4px;'>
<div style='width:100%;padding:4px;'><h2><a href='more.php?id=$id&abc=churches'>$title</a></h2></div>
<div style='width:100%;padding:4px;'>$short</div>
</td>
</tr>
<tr>
<td  style='height:30px;padding:4px;'>
<a href='more.php?id=$id&abc=churches' class='more' style='color:white' >$more</a>
</td>
<td></td>
</tr>
</table>
