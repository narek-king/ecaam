...
//pagination
	...
	$tableName='presscontent';		//your table name
	...
	*/
	...
	$targetpage = "press.php"; 	//your file name  (the name of this file)
...
<div style='width:100%;padding:4px;'><h2><a href='more.php?id=$id&abc=presscontent'>$title</a></h2></div>
<div style='width:100%;padding:4px;'>$short</div>
</td>
</tr>
<tr>
<td  style='height:30px;padding:4px;'>
<a href='more.php?id=$id&abc=presscontent' class='more' style='color:white' >$more</a>
</td>
<td></td>
</tr>
</table>
